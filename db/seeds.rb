...
# Create users
kiv = User.create! email: 'kiv@gmail.com', password: '123456', first_name: 'Kiv', last_name: 'Benzopyla'
puts "Created user #{kiv.first_name} - API token #{kiv.authentication_token} "
bob = User.create! email: 'bob@gmail.com', password: '123456', first_name: 'Bob', last_name: 'Jones'
puts "Created user #{bob.first_name} - API token #{bob.authentication_token} "
alice = User.create! email: 'alice@gmail.com', password: '123456', first_name: 'Alice', last_name: 'Griffin'
puts "Created user #{alice.first_name} - API token #{alice.authentication_token} "
puts '-----------------------------'
...
puts "Created a watchlist for #{kiv_bob_list.user_1.first_name} and #{kiv_bob_list.user_2.first_name}"
